...
func (hcd *HtlvCrcDecoder) Intercept(chain iface.IChain) iface.IcResp {
	...
	//log.Ins().DebugF("HTLVCRC-RawData size:%d data:%s\n", len(data), hex.EncodeToString(data))
