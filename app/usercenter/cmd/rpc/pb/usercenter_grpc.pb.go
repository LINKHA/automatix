...
const (
	...
	Usercenter_Fastlogin_FullMethodName            = "/pb.usercenter/fastlogin"
...
type UsercenterClient interface {
	...
	Fastlogin(ctx context.Context, in *FastLoginReq, opts ...grpc.CallOption) (*FastLoginResp, error)
...
func (c *usercenterClient) Fastlogin(ctx context.Context, in *FastLoginReq, opts ...grpc.CallOption) (*FastLoginResp, error) {
	out := new(FastLoginResp)
	err := c.cc.Invoke(ctx, Usercenter_Fastlogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsercenterServer interface {
	...
	Fastlogin(context.Context, *FastLoginReq) (*FastLoginResp, error)
...
func (UnimplementedUsercenterServer) Fastlogin(context.Context, *FastLoginReq) (*FastLoginResp, error) {
...
func _Usercenter_Fastlogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FastLoginReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsercenterServer).Fastlogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Usercenter_Fastlogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).Fastlogin(ctx, req.(*FastLoginReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Usercenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Usercenter_Fastlogin_Handler,
		},
		{
			MethodName: "register",
