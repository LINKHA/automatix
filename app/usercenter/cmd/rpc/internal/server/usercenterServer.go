...
func (s *UsercenterServer) Fastlogin(ctx context.Context, in *pb.FastLoginReq) (*pb.FastLoginResp, error) {
	l := logic.NewFastloginLogic(ctx, s.svcCtx)
	return l.Fastlogin(in)
}
