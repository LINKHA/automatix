...
type (
	FastLoginReq             = pb.FastLoginReq
	FastLoginResp            = pb.FastLoginResp
...
func (m *defaultUsercenter) Fastlogin(ctx context.Context, in *FastLoginReq, opts ...grpc.CallOption) (*FastLoginResp, error) {
	client := pb.NewUsercenterClient(m.cli.Conn())
	return client.Fastlogin(ctx, in, opts...)
}
